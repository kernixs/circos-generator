...
`CircosViewerAssets.javascript()` without relying on this repository's checkout
layout. This is an integration contract only; it does not select or implement
